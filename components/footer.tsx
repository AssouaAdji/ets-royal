    ...
    <footer className="border-t bg-muted/50">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2 text-sm inline-block">
              ...
              <li>
                <Link href="/alimentation" className="text-muted-foreground hover:text-primary transition-colors">
                  {t("food")}
                </Link>
              </li>
              <li>
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground inline-block">
              ...
              <li>{t("servicesDesc")}</li>
              <li>{t("serviceEntretienTitle")}</li>
            </ul>
          </div>
        ...
        <div className="border-t mt-8 pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} ETS ROYAL COMPANY SERVICE. {t("allRightsReserved")}</p>
        </div>
      </div>
    </footer>
  )
